...
class NesterovARunFuncTestsProcesses : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    // Read image
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_marin_l_cnt_mismat_chrt_in_two_str, "pic.jpg");
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<MarinLCntMismatChrtInTwoStrMPI, InType>(kTestParam, PPC_SETTINGS_marin_l_cnt_mismat_chrt_in_two_str),
                   ppc::util::AddFuncTask<MarinLCntMismatChrtInTwoStrSEQ, InType>(kTestParam, PPC_SETTINGS_marin_l_cnt_mismat_chrt_in_two_str));
